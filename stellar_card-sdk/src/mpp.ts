...
//
// For stellar_card specifically, the challenge's Stellar method maps onto
...
export interface MppChargeOpts {
  /**
   * The full MPP resource URL. E.g. 'https://api.stellar_card.com/v1/cards/visa/10.00'.
   * This is the standards-compliant mode — works against any MPP server.
   */
  url?: string;

  /**
   * Convenience: build the URL from the stellar_card base URL + USD amount.
