...
export function CreateAgentDrawer({ open, onClose }: Props) {
  ...
  const snippet = created?.claim
    ? [
        'Read https://stellar_card.com/skill.md and set up this agent by running:',
        `npx -y stellar_card@latest onboard --claim ${created.claim.code}`,
      ].join('\n')
    : '';
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          >
            ...
            <StepRow
              ...
              detail="Send at least 2 XLM to activate the wallet and cover reserves. To receive USDC, the agent must first open a trustline (run `stellar_card wallet trustline` after funding with XLM)."
            />
            <StepRow
          ...
          {walletAddress && (
            ...
            >
              ...
              >
                ...
                <code>stellar_card wallet trustline</code>. The stepper will flip to{' '}
