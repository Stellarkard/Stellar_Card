...
const POST_URL =
  'https://stellar_card.com/blog/claim-codes-credentials-that-never-touch-the-transcript';
const POST_DATE = '2026-04-14';

export const metadata: Metadata = {
  title: 'Claim codes: credentials that never touch the transcript',
  description:
    'Why Stellar_Card onboards agents with single-use claim codes instead of raw API keys, and how the exchange flow avoids credential-in-prompt failure.',
  alternates: { canonical: POST_URL },
  openGraph: ogForPage({
    title: 'Claim codes: credentials that never touch the transcript — Stellar_Card',
    description:
  ...
  twitter: twitterForPage({
    title: 'Claim codes: credentials that never touch the transcript',
    description:
      'Why Stellar_Card onboards agents with single-use claim codes instead of raw API keys.',
  }),
};
...
const blogJsonLd = {
  ...
  description: 'Why Stellar_Card onboards agents with single-use claim codes instead of raw API keys.',
  datePublished: POST_DATE,
  dateModified: POST_DATE,
  author: { '@type': 'Organization', name: 'Stellar_Card', url: 'https://stellar_card.com' },
  publisher: {
    '@type': 'Organization',
    name: 'Stellar_Card',
    logo: { '@type': 'ImageObject', url: 'https://stellar_card.com/icon.png' },
  },
  image: 'https://stellar_card.com/opengraph-image',
  keywords:
...
const breadcrumbJsonLd = {
  ...
  '@type': 'BreadcrumbList',
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'Blog', item: 'https://stellar_card.com/blog' },
    {
      '@type': 'ListItem',
      position: 2,
      ...
      >
        ...
        <header style={{ marginBottom: '3rem' }}>
          ...
          >
            ...
            <span>·</span>
            <span>by Stellar_Card engineering</span>
          </div>
        </header>

        <div className="post-body">
          <p className="lede">
            The first version of Stellar_Card onboarded agents the same way every API has onboarded
          ...
          <p>
            Picture an operator using a Claude Desktop or Cursor agent to set up a new Stellar_Card
          ...
          <p>
            ...
            web apps. It was the wrong answer for Stellar_Card because the agent doesn&apos;t have a
          ...
          <p>
            The operator runs <code>stellar_card onboard --claim c402_...</code> exactly once, inside
            the agent&apos;s runtime. The CLI trades the claim for the real API key over HTTPS,
            writes the key to <code>~/.stellar_card/config.json</code> with 0600 permissions, and asks
          ...
          <ul>
            ...
            <li>
              ...
              <code>~/.stellar_card/config.json</code> and pastes the contents into the LLM chat,
          ...
          <p>
            Stellar_Card is the result of auditing each of those assumptions one at a time and fixing
          ...
          <p>
            ...
            <a href="mailto:security@stellar_card.com">security@stellar_card.com</a>. We read every one.
          </p>
        </div>
