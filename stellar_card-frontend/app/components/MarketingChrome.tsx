// Marketing chrome — sticky nav with the Stellar_Card wordmark, plus a
        ...
        >
          ...
          >
            ...
            <FooterCol title="Network">
              ...
              <FooterLink href="https://www.npmjs.com/package/stellar_card" external>
                npm · stellar_card
              </FooterLink>
              <FooterLink href="https://github.com/CTX-com/Stellar_Card" external>
                GitHub
              </FooterLink>
          ...
          >
            <span>
              © {new Date().getFullYear()} Stellar_Card. Cards issued by Pathward, N.A., Member FDIC.
            </span>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.1rem' }}>
              ...
              <div style={{ display: 'flex', gap: '0.65rem' }}>
                <a
                  href="https://x.com/stellar_card"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="Stellar_Card on X"
                  style={{
                    color: 'var(--fg-dim)',
                    display: 'inline-flex',
                ...
                <a
                  href="https://github.com/CTX-com/Stellar_Card"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="Stellar_Card on GitHub"
                  style={{
                    color: 'var(--fg-dim)',
                    display: 'inline-flex',
                    transition: 'color 0.3s var(--ease-out)',
                ...
                <a
                  ...
                  aria-label="Stellar_Card changelog RSS feed"
                  style={{
                    color: 'var(--fg-dim)',
                    display: 'inline-flex',
                    transition: 'color 0.3s var(--ease-out)',
